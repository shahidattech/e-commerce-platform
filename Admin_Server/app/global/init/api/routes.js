...
var invoiceApi = require(path.join(__dirname, '..', '..', '..', 'routes', 'invoice', 'invoiceApi'));
var subscriptionApi = require(path.join(__dirname, '..', '..', '..', 'routes', 'subscription', 'subscriptionApi'));
...
//console.log(middleware)
    ...
    ordersApi(app);
    invoiceApi(app);
    subscriptionApi(app, middleware);
};
